...
PACKAGE_EXCLUDE = "${@bb.utils.contains('DISTRO', 'overc', 'busybox busybox-dev busybox-udhcpc busybox-dbg busybox-ptest busybox-udhcpd busybox-hwclock busybox-syslog', '', d )}"
